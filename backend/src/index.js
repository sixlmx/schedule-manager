...
fastify.register((fastify) => {
  fastify.register(import('./routes/teachers.js'), { prefix: '/apiv1' });
  fastify.register(import('./routes/bells.js'), { prefix: '/apiv1' });
  fastify.register(import('./routes/subjects.js'), { prefix: '/apiv1' });
  fastify.register(import('./routes/groups.js'), { prefix: '/apiv1' });
  fastify.register(import('./routes/lessons.js'), { prefix: '/apiv1' });
  ...
  fastify.register(import('./routes/publication.js'), { prefix: '/apiv1' });
});
